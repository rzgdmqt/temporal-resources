...
mutual 
    ...
    data _↝_ :  {C D : CType} → Config C → Config D → Set where
        ...
        SEQ-FST : {τ τ₁ τ₂ τ₃ τ₄ : Time} → 
                ...
                ⟨ S₁ , M₁ ;  
                    C-rename 
                        (cong-∷-ren (suc-comp-ren (step-extends-state M↝M₁) (m≡n⇒m≤n τ+τ₂≡τ₁+τ₄))) 
                        N ⟩
        ...
        BOX :   {τ τ' τ'' : Time} → {S : 𝕊 τ} → {A B : VType} → 
                ...
                {M : toCtx S ∷ [ τ' ] A ⊢C⦂ B ‼ τ''} →
                -------------------------------------------------------
                ⟨ S , (box V M) ⟩ ↝ ⟨ extend-state S τ' V , M ⟩
...
perservation-theorem {τ = τ} {τ'} (SEQ-FST {τ₂ = τ₂} {τ₃} {τ₄} τ+τ₂≡τ₁+τ₄ M↝M') = 
...
perservation-theorem {τ = τ} {τ'} (HANDLE-STEP {τ₁ = τ₁} {τ₂} {τ₃} τ+τ₂≡τ₄+τ₃ M↝M') = 
    refl , τ+τ₂≡τ₁+τ₄⇒τ+[τ₂+τ₃]≡τ₁+[τ₄+τ₃] τ τ' τ₂ τ₁ τ₃ τ+τ₂≡τ₄+τ₃
