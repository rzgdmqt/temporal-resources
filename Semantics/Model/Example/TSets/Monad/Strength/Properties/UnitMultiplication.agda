...
module Semantics.Model.Example.TSets.Monad.Strength.Properties.UnitMultiplication where
...
-- Strength's interaction with unit of the graded monad
...
-- Strength's interaction with multiplication of the graded monad
